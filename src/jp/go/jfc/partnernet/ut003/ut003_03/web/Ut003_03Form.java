...
/**
 * <pre>
 * このクラスはut003_03のFormクラスです。
 * </pre>
 *
 * @author 林　晃平
 * @version 2.0.0
 */
public class Ut003_03Form extends PNBaseForm {

    /** serialVersionUID */
    private static final long serialVersionUID = 1L;

    /** 金利情報文書一覧 */
    private PNPagingTable<Ut003_03M1DTO> Ut003_03M1Table = new PNPagingTableSerial<Ut003_03M1DTO>(
            "Ut003_03M1Table");
    ...
    /** 金利情報文書一覧 */
    private List<Ut003_03M1DTO> KinriJyohoList;
// [ADD] Ver 2.0.0 - START
    /** 検索開始元号 */
...
// [ADD] Ver 2.0.0 - END
    ...
    /** 検索結果表示領域 */
    private Ut003_03DTO SearchDataArea;
    /** 選択行番号 */
     ...
     * @return 金利情報文書一覧
     */
    public PNPagingTable<Ut003_03M1DTO> getUt003_03M1Table() {
        return Ut003_03M1Table;
    }

    /**
     * 金利情報文書一覧を設定します。
     * @param Ut003_03M1Table 金利情報文書一覧
     */
    public void setUt003_03M1Table(PNPagingTable<Ut003_03M1DTO> Ut003_03M1Table) {
        this.Ut003_03M1Table = Ut003_03M1Table;
    }

    /**
     * 金利情報文書一覧テーブルレコードを取得します。
     * @return 金利情報文書一覧テーブル
     */
    public List<Ut003_03M1DTO> getUt003_03M1TableRecord() {
        return getUt003_03M1Table().getRecordList();
    }
     ...
     * @return 金利情報文書一覧
     */
    public List<Ut003_03M1DTO> getKinriJyohoList() {
        return KinriJyohoList;
    }

    /**
     * 金利情報文書一覧を設定します。
     * @param KinriJyohoList 金利情報文書一覧
     */
    public void setKinriJyohoList(List<Ut003_03M1DTO> KinriJyohoList) {
...
// [ADD] Ver 2.0.0 - END
     ...
     * @return 検索結果表示領域
     */
    public Ut003_03DTO getSearchDataArea() {
     ...
     */
    public void setSearchDataArea(Ut003_03DTO SearchDataArea) {
