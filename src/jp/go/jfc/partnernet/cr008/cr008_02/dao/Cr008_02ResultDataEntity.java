...
// Class Name   : Cr008_02ResultDataEntity
//
...
/**
 * <pre>
 * このクラスはCr008_02ResultDataDAOのEntityクラスです。
 * </pre>
 *
 * @author 石川　真理
 * @version 1.0.0
 */
public class Cr008_02ResultDataEntity extends PNBaseEntity {
     ...
     * @return 顧客名入力値
     */
    public String getCr008_02_In_Name_Customer() {
        return (String) getValue("Cr008_02_In_Name_Customer");
    }

    /**
     * 顧客名入力値を設定します。
     * @param Cr008_02_In_Name_Customer 顧客名入力値
     */
    public void setCr008_02_In_Name_Customer(String Cr008_02_In_Name_Customer) {
        setValue("Cr008_02_In_Name_Customer", Cr008_02_In_Name_Customer);
    }
     ...
     * @return ログインユーザ扱店コード
     */
    public String getCr008_02_Code_Organization() {
        return (String) getValue("Cr008_02_Code_Organization");
    }

    /**
     * ログインユーザ扱店コードを設定します。
     * @param Cr008_02_Code_Organization ログインユーザ扱店コード
     */
    public void setCr008_02_Code_Organization(String Cr008_02_Code_Organization) {
        setValue("Cr008_02_Code_Organization", Cr008_02_Code_Organization);
    }
    ...
    /**
     * 市区郡町村名を設定します。
     * @param Name_Shikugunchoson 市区郡町村名
     */
