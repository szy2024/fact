 ...
 * @version 1.0.0
 */
public class Se002_01M1DTO extends PNBaseDTO {
    ...
    /** 実行未了_資金払出期限 */
    private String ID_Date_HaraidashiKigen;
     ...
     * @throws Exception 例外
     */
    public Se002_01M1DTO(Se002_01M1DTO orig) {
        super(orig);
    }
    ...
    /**
     * 実行未了_顧客名を設定します。
     * @param ID_Name_Customer 実行未了_顧客名
     */
    ...
    /**
     * 実行未了_公庫支店を設定します。
     * @param ID_Name_KoukoShiten 実行未了_公庫支店
     */
    ...
    /**
     * 実行未了_扱店を設定します。
     * @param ID_Code_Organization 実行未了_扱店
     */
    ...
    /**
     * 実行未了_方式資金を設定します。
     * @param ID_Kubun_Hoshiki 実行未了_方式資金
     */
    ...
    /**
     * 実行未了_枝番を設定します。
     * @param ID_ID_RingiBranch 実行未了_枝番
     */
    ...
    /**
     * 実行未了_貸付決定日を設定します。
     * @param ID_Date_JuriKetteikisan 実行未了_貸付決定日
     */
    ...
    /**
     * 実行未了_貸付実行予定日を設定します。
     * @param ID_Shinko_Kanri_Date_Jikko 実行未了_貸付実行予定日
     */
    ...
    /**
     * 実行未了_貸付実行額を設定します。
     * @param ID_M_Kashitsuke 実行未了_貸付実行額
     */
    ...
    /**
     * 実行未了_資金払出未了額を設定します。
     * @param ID_M_KashitsukeukeireZan 実行未了_資金払出未了額
     */
    ...
    /**
     * 実行未了_貸付実行期限を設定します。
     * @param ID_Date_JikkoKigen 実行未了_貸付実行期限
     */
     ...
     * @return 実行未了_資金払出期限
     */
    public String getID_Date_HaraidashiKigen() {
        return ID_Date_HaraidashiKigen;
    }

    /**
     * 実行未了_資金払出期限を設定します。
     * @param ID_Date_HaraidashiKigen 実行未了_資金払出期限
     */
    public void setID_Date_HaraidashiKigen(String ID_Date_HaraidashiKigen) {
        this.ID_Date_HaraidashiKigen = ID_Date_HaraidashiKigen;
    }
