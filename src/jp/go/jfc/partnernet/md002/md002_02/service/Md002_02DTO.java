...
/**
 * <pre>
 * このクラスはmd002_02のDTOクラスです。
 * </pre>
 *
 * @author 小菱　忠雄
 * @version 1.0.0
 */
public class Md002_02DTO extends PNBaseDTO {
	...
	/** 取消済みフラグ（非表示） */
	private java.math.BigDecimal ID_Flag_Torikeshizumi;
	/** エラーコード（非表示） */
	 ...
	 * @throws Exception 例外
	 */
	public Md002_02DTO(Md002_02DTO orig) {
		super(orig);
	}
	 ...
	 * @return 取消済みフラグ（非表示）
	 */
	public java.math.BigDecimal getID_Flag_Torikeshizumi() {
	 ...
	 */
	public void setID_Flag_Torikeshizumi(java.math.BigDecimal ID_Flag_Torikeshizumi) {
	 ...
	 * @return 処理モード
	 */
	public boolean getSeikyuShuseiUp() {
		return seikyuShuseiUp;
	}
	 ...
	 * @return 処理モード
	 */
	public void setSeikyuShuseiUp(boolean seikyuShuseiUp) {
		this.seikyuShuseiUp = seikyuShuseiUp;
	}
	 ...
	 * @param Process_Mode 処理モード
	 */
	public void setRingiRedFlg(String ringiRedFlg) {
		this.ringiRedFlg = ringiRedFlg;
	}
	 ...
	 * @param Process_Mode 処理モード
	 */
	public void setSaveProcMode(int saveProcMode) {
		this.saveProcMode = saveProcMode;
	}
	 ...
	 * @return 処理モード
	 */
	public String getCharCode_ShokanHouhou() {
		return charCode_ShokanHouhou;
	}

	/**
	 * 処理モードを設定します。
	 * @param charCode_ShokanHouhou 処理モード
	 */
	public void setCharCode_ShokanHouhou(String charCode_ShokanHouhou) {
		this.charCode_ShokanHouhou = charCode_ShokanHouhou;
	}
