...
/**
 * <pre>
 * このクラスはcr005_04のDTOクラスです。
 * </pre>
 *
 * @author 嶋田　美保
 * @version 2.0.0
 */
public class Cr005_04DTO extends PNBaseDTO {
    ...
    /** 請求検索結果・取得件数 */
    private Integer ID_SeikyuCount;
    /** 請求検索結果・約定元金 */
     ...
     *             例外
     */
    public Cr005_04DTO(Cr005_04DTO orig) {
        super(orig);
    }
     ...
     * @return 請求検索結果・取得件数
     */
    public Integer getID_SeikyuCount() {
     ...
     *            請求検索結果・取得件数
     */
    public void setID_SeikyuCount(Integer ID_SeikyuCount) {
