...
/**
 * <pre>
 * このクラスはmd004_02のDTOクラスです。
 * </pre>
 *
 * @author 小菱　忠雄
 * @version 1.0.0
 */
public class Md004_02DTO extends PNBaseDTO {
    ...
    /** SAVEデータの賦金 */
    private java.math.BigDecimal Save_ID_M_Fukin;
    /** SAVEデータの元金不均等額 */
    private java.math.BigDecimal Save_ID_M_GankinFukinto;
    /** SAVEデータの償還期限年月 */
    private String Save_ID_Date_ShokanKigen;
    /** SAVEデータの約定元金 */
    private java.math.BigDecimal Save_ID_M_YakujoGankin;
    /** SAVEデータの約定利息 */
    private java.math.BigDecimal Save_ID_M_YakujoRisoku;
    /** SAVEデータの調整コード */
    private String Save_ID_Code_Chosei;
    /** SAVEデータの貸付残高 */
    private java.math.BigDecimal Save_ID_M_KashitsukeZan;
    /** 報告時分秒(非表示) */
     ...
     * @throws Exception 例外
     */
    public Md004_02DTO(Md004_02DTO orig) {
        super(orig);
    }
    ...
    /**
     * 繰償後第１回払込期日を設定します。
     * @param lblID_Date_FirstHaraikomiAfterKurisho_Red 繰償後第１回払込期日
     */
    ...
    /**
     * 繰償後第１回払込期日（修正）を取得します。
     * @return 繰償後第１回払込期日（修正）
     */
    ...
    /**
     * 繰償後第１回払込期日（修正）を設定します。
     * @param lblID_Date_FirstHaraikomiAfterKurisho 繰償後第１回払込期日（修正）
     */
     ...
     */
    public void setLblID_M_KurishoCommision(String lblID_M_KurishoCommission) {
    ...
    /**
     * 繰償後第１回払込期日を設定します。
     * @param txtID_Date_FirstHaraikomiAfterKurisho_Red 繰償後第１回払込期日
     */
    ...
    /**
     * 繰償後第１回払込期日(修正)（入力値連結）を取得します。
     * @return 繰償後第１回払込期日(修正)（入力値連結）
     */
    ...
    /**
     * 繰償後第１回払込期日(修正)（入力値連結）を設定します。
     * @param ID_Date_FirstHaraikomiAfterKurisho_Input 繰償後第１回払込期日(修正)（入力値連結）
     */
    ...
    /**
     * 繰償後第１回払込期日(DB取得値)を取得します。
     * @return 繰償後第１回払込期日(DB取得値)
     */
    ...
    /**
     * 繰償後第１回払込期日(DB取得値)を設定します。
     * @param ID_Date_FirstHaraikomiAfterKurisho_Save 繰償後第１回払込期日(DB取得値)
     */
     ...
     * @return SAVEデータの賦金
     */
    public java.math.BigDecimal getSave_ID_M_Fukin() {
     ...
     */
    public void setSave_ID_M_Fukin(java.math.BigDecimal Save_ID_M_Fukin) {
     ...
     */
    public java.math.BigDecimal getSave_ID_M_GankinFukinto() {
     ...
     */
    public void setSave_ID_M_GankinFukinto(java.math.BigDecimal Save_ID_M_GankinFukinto) {
     ...
     * @return SAVEデータの約定元金
     */
    public java.math.BigDecimal getSave_ID_M_YakujoGankin() {
     ...
     */
    public void setSave_ID_M_YakujoGankin(java.math.BigDecimal Save_ID_M_YakujoGankin) {
     ...
     * @return SAVEデータの約定利息
     */
    public java.math.BigDecimal getSave_ID_M_YakujoRisoku() {
     ...
     */
    public void setSave_ID_M_YakujoRisoku(java.math.BigDecimal Save_ID_M_YakujoRisoku) {
     ...
     * @return SAVEデータの貸付残高
     */
    public java.math.BigDecimal getSave_ID_M_KashitsukeZan() {
     ...
     */
    public void setSave_ID_M_KashitsukeZan(java.math.BigDecimal Save_ID_M_KashitsukeZan) {
