...
// Class Name   : Cr004_02AnchorController
//
...
/**
 * <pre>
 * このクラスはCr004_02の顧客名アンカーコントローラークラスです。
 * </pre>
 *
 * @author 佐藤　晃
 * @version 1.0.0
...
@RequestMapping(value = "/Cr004_02Anchor.form")
public class Cr004_02AnchorController extends Cr004_02BaseController {

    /** Log */
    private static Log log = LogFactory.getLog(Cr004_02AnchorController.class);
    ...
    public String executeAction(Model model, Cr004_02Form form, Errors errors, HttpServletRequest request,
        ...
        String codeCustomer = form.getCr004_02M1Table().getRecordList().get(selectedIndex)
                .getID_Code_Customer();
        String nameCustomer = form.getCr004_02M1Table().getRecordList().get(selectedIndex)
                .getID_Name_Customer();
        String codeOrganization = form.getCr004_02M1Table().getRecordList().get(selectedIndex)
                .getID_Code_Organization();
        String customerAddress = form.getCr004_02M1Table().getRecordList().get(selectedIndex)
        ...
        // 貸付先コード
        addForwardParameter(request, Cr004Constants.PROPERTY_CODE_CUSTOMER, codeCustomer);
        // 顧客名
        addForwardParameter(request, Cr004Constants.PROPERTY_NAME_CUSTOMER, nameCustomer);
        // 扱店コード
        addForwardParameter(request, Cr004Constants.PROPERTY_CODE_ORGANIZATION, codeOrganization);
        // 住所
        addForwardParameter(request, Cr004Constants.PROPERTY_ADDRESS, customerAddress);
        ...
        return success(Cr004Constants.EVENT_ID_CR004_03INIT);
