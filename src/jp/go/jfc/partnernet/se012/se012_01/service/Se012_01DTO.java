 ...
 * @version 2.0.0
 */
public class Se012_01DTO extends PNBaseDTO {
     ...
     *             例外
     */
    public Se012_01DTO(Se012_01DTO orig) {
        super(orig);
    }
     ...
     * 検索扱店コードを設定します。
     *
     * @param txtid_srccode_organization
     *            検索扱店コード
     */
     ...
     * 検索開始年月（年）を設定します。
     *
     * @param drpid_searchstartym_year
     *            検索開始年月（年）
     */
     ...
     * 検索開始年月（月）を設定します。
     *
     * @param drpid_searchstartym_month
     *            検索開始年月（月）
     */
     ...
     *
     * @param ym_searchstart_year_pulldown_list
     *            検索開始年月（年）プルダウンリスト
     */
    public void setYm_searchstart_year_pulldown_list(
            LinkedHashMap<String, Object> ym_searchstart_year_pulldown_list) {
     ...
     *
     * @param ym_searchstart_month_pulldown_list
     *            検索開始年月（月）プルダウンリスト
     */
     ...
     *
     * @param ym_searchend_year_pulldown_list
     *            検索終了年月（年）プルダウンリスト
     */
    public void setYm_searchend_year_pulldown_list(
            LinkedHashMap<String, Object> ym_searchend_year_pulldown_list) {
     ...
     *
     * @param ym_searchend_month_pulldown_list
     *            検索終了年月（月）プルダウンリスト
     */
    public void setYm_searchend_month_pulldown_list(
            LinkedHashMap<String, Object> ym_searchend_month_pulldown_list) {
