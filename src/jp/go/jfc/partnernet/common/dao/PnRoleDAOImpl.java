 ...
 * @version 2.0.0
 */
public class PnRoleDAOImpl extends PNSingleTableDAO<PnRoleEntity> implements PnRoleDAO {
     ...
     */
    @Override
    public PnRoleEntity findByPrimaryKey(PnRoleEntity inEntity) throws
        ...
        sql.where(" RoleCode = ?", inEntity.getValue("RoleCode"));

        return executeSingleResult(sql, PnRoleEntity.class);
    }
     ...
     */
    @Override
    public List<PnRoleEntity> findByCondition(PnRoleEntity inEntity) {
        ...
        return executeListResult(sql, PnRoleEntity.class);
    }
     ...
     */
    @Override
    public List<PnRoleEntity> findByCondition(PnRoleEntity inEntity, int offset, int length) {
        ...
        return executeListResult(sql, PnRoleEntity.class, offset, length);
    }
     ...
     */
    @Override
    public long countByCondition(PnRoleEntity inEntity) {
     ...
     */
    @Override
    public PnRoleEntity findByPrimaryKeyForUpdate(PnRoleEntity inEntity) throws
        ...
        return executeSingleResultForUpdate(sql, PnRoleEntity.class);
    }
     ...
     */
    @Override
    public int insert(PnRoleEntity inEntity) throws CFWDuplicateKeyException {

        PNSqlBuilder sql = new PNSqlBuilder();
        sql.append("INSERT INTO PN_Role ");
        sql.append("(");
     ...
     */
    @Override
    public int update(PnRoleEntity inEntity) throws CFWFindParameterException,
     ...
     */
    @Override
    public int delete(PnRoleEntity inEntity) throws CFWFindParameterException {

        PNSqlBuilder sql = new PNSqlBuilder();
        sql.append("DELETE FROM PN_Role ");
