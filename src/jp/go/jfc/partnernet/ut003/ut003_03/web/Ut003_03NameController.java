...
// Class Name   : Ut003_03NameController
//
...
/**
 * <pre>
 * このクラスはut003_03の金利情報ファイルアンカーコントローラークラスです。
 * </pre>
 *
 * @author 譚　暁玉
 * @version 1.0.0
...
@RequestMapping(value = "/Ut003_03Name.form")
public class Ut003_03NameController extends Ut003_03BaseController {
    ...
    public String executeAction(Model model, Ut003_03Form form, Errors errors, HttpServletRequest request,
        ...
        Ut003_03M1DTO selectedData = form.getUt003_03M1TableRecord().get(selectedIndex);
        String filename = PNResourceBundle.getApplicationProperty(Ut003Constants.DOWNLOAD_PATH_KINRIJYOHO)
