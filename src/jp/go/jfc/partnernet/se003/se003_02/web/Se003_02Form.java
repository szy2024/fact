...
/**
 * <pre>
 * このクラスはSe003_02のFormクラスです。
 * </pre>
 *
 * @author 小菱　忠雄
 * @version 1.0.0
 */
public class Se003_02Form extends PNBaseForm {

    /** serialVersionUID */
    private static final long serialVersionUID = 1L;

    /** 払出情報 */
    private PNPagingTable<Se003_02M1DTO> Se003_02M1Table = new PNPagingTableSerial<Se003_02M1DTO>(
            "Se003_02M1Table");
    // private PNPagingTable<Se003_02M1DTO> Se003_02M1Table
    // = new PNPagingTableMemory<Se003_02M1DTO>("Se003_02M1Table");

    /** 払込情報 */
    private PNPagingTable<Se003_02M2DTO> Se003_02M2Table = new PNPagingTableSerial<Se003_02M2DTO>(
            "Se003_02M2Table");
    // private PNPagingTable<Se003_02M2DTO> Se003_02M2Table
    // = new PNPagingTableMemory<Se003_02M2DTO>("Se003_02M2Table");
    ...
    /** 元利又は元金均等額 */
    @NumberFormat(pattern = "#,###")
    private BigDecimal ID_M_Fukin;
    /** 元金不均等額 */
    @NumberFormat(pattern = "#,###")
    private BigDecimal ID_M_GankinFukinto;
    /** 貸付決定日 */
    ...
    /** 貸付実行額 */
    @NumberFormat(pattern = "#,###")
    private BigDecimal ID_M_KashitsukeJikko;
    /** 貸付金現在残高 */
    @NumberFormat(pattern = "#,###")
    private BigDecimal ID_M_KashitsukeZandaka;
    /** メッセージ（注意喚起メッセージ） */
    ...
    /** 払出情報 */
    private List<Se003_02M1DTO> MEISAI_HaraidashiLIST;
    /** 払込情報 */
    private List<Se003_02M2DTO> MEISAI_HaraikomiLIST;

    /**
     * 払出情報を取得します。
     * @return 払出情報
     */
    public PNPagingTable<Se003_02M1DTO> getSe003_02M1Table() {
        return Se003_02M1Table;
    }

    /**
     * 払出情報を設定します。
     * @param Se003_02M1Table 払出情報
     */
    public void setSe003_02M1Table(PNPagingTable<Se003_02M1DTO> Se003_02M1Table) {
        this.Se003_02M1Table = Se003_02M1Table;
    }
     ...
     * @return 払出情報テーブル
     */
    public List<Se003_02M1DTO> getSe003_02M1TableRecord() {
        return getSe003_02M1Table().getRecordList();
    }
     ...
     * @return 払込情報
     */
    public PNPagingTable<Se003_02M2DTO> getSe003_02M2Table() {
        return Se003_02M2Table;
    }

    /**
     * 払込情報を設定します。
     * @param Se003_02M2Table 払込情報
     */
    public void setSe003_02M2Table(PNPagingTable<Se003_02M2DTO> Se003_02M2Table) {
        this.Se003_02M2Table = Se003_02M2Table;
    }
     ...
     * @return 払込情報テーブル
     */
    public List<Se003_02M2DTO> getSe003_02M2TableRecord() {
        return getSe003_02M2Table().getRecordList();
    }
     ...
     * @return 元利又は元金均等額
     */
    public BigDecimal getID_M_Fukin() {
        return ID_M_Fukin;
    }
     ...
     */
    public void setID_M_Fukin(BigDecimal ID_M_Fukin) {
     ...
     * @return 元金不均等額
     */
    public BigDecimal getID_M_GankinFukinto() {
     ...
     */
    public void setID_M_GankinFukinto(BigDecimal ID_M_GankinFukinto) {
     ...
     * @return 貸付実行額
     */
    public BigDecimal getID_M_KashitsukeJikko() {
     ...
     */
    public void setID_M_KashitsukeJikko(BigDecimal ID_M_KashitsukeJikko) {
     ...
     * @return 貸付金現在残高
     */
    public BigDecimal getID_M_KashitsukeZandaka() {
     ...
     */
    public void setID_M_KashitsukeZandaka(BigDecimal ID_M_KashitsukeZandaka) {
     ...
     * @return 払出情報
     */
    public List<Se003_02M1DTO> getMEISAI_HaraidashiLIST() {
     ...
     */
    public void setMEISAI_HaraidashiLIST(List<Se003_02M1DTO> MEISAI_HaraidashiLIST) {
     ...
     * @return 払込情報
     */
    public List<Se003_02M2DTO> getMEISAI_HaraikomiLIST() {
     ...
     */
    public void setMEISAI_HaraikomiLIST(List<Se003_02M2DTO> MEISAI_HaraikomiLIST) {
