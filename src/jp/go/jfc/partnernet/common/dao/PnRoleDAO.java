...
/**
 * <pre>
 * このクラスは権限種別テーブルの単テーブルアクセスDAOインタフェースです。
 * データーベースアクセス各種機能
 * （検索／追加／更新／削除機能）
 * を提供します。
 * </pre>
...
public interface PnRoleDAO {
     ...
     */
    PnRoleEntity findByPrimaryKey(PnRoleEntity inEntity) throws CFWFindParameterException;
     ...
     * @return 検索結果（複数件）
     */
    List<PnRoleEntity> findByCondition(PnRoleEntity inEntity);
     ...
     * @return 検索結果（複数件）
     */
    List<PnRoleEntity> findByCondition(PnRoleEntity inEntity, int offset, int length);
     ...
     * @return 検索結果（ヒット件数）
     */
    long countByCondition(PnRoleEntity inEntity);
     ...
     */
    PnRoleEntity findByPrimaryKeyForUpdate(PnRoleEntity inEntity) throws CFWFindParameterException,
     ...
     */
    int insert(PnRoleEntity inEntity) throws CFWDuplicateKeyException;
     ...
     * @throws CFWFindParameterException パラメーターが不正な時に発生
     */
    int update(PnRoleEntity inEntity) throws CFWFindParameterException,
     ...
     * @throws CFWFindParameterException パラメーターが不正な時に発生
     */
    int delete(PnRoleEntity inEntity) throws CFWFindParameterException;
