...
// Class Name   : Ut003_05NameController
//
...
/**
 * <pre>
 * このクラスはut003_05の様式名アンカーコントローラークラスです。
 * </pre>
 *
 * @author 譚　暁玉
 * @version 1.0.0
...
@RequestMapping(value = "/Ut003_05Name.form")
public class Ut003_05NameController extends Ut003_05BaseController {
    ...
    public String executeAction(Model model, Ut003_05Form form, Errors errors, HttpServletRequest request,
        ...
        Ut003_05M1DTO selectedData = form.getUt003_05M1TableRecord().get(selectedIndex);
