...
// Class Name   : Ut003_02GetResultDataEntity
//
...
//==================================================================================================
package jp.go.jfc.partnernet.ut003.ut003_02.dao;

import jp.go.jfc.partnernet.pnfw.dao.entity.PNBaseEntity;

/**
 * <pre>
 * このクラスはUt003_02GetResultDataDAOのEntityクラスです。
 * </pre>
 *
 * @author 譚　暁玉
 * @version 1.0.0
 */
public class Ut003_02GetResultDataEntity extends PNBaseEntity {
    ...
    public String getID_ID_DocNumber() {
        return (String) getValue("ID_ID_DocNumber");
    }
    ...
    public void setID_ID_DocNumber(String ID_ID_DocNumber) {
        setValue("ID_ID_DocNumber", ID_ID_DocNumber);
    }
