...
/**
 * <pre>
 * このクラスはcr006_02のFormクラスです。
 * </pre>
 *
 * @author 林　晃平
 * @version 2.0.0
 */
public class Cr006_02Form extends PNBaseForm {
    ...
    /** 計算結果:計（円） */
    private String Ans_M_Kei;
    /** 計算結果:送金額（円） */
    private String Ans_M_Sokin;
    /** 計算結果:受入後立替金残高（円） */
    private String Ans_M_TatekaeZanAfterUkeire;
    /** 受託者勘定処理年月設定モード */
     ...
     * </pre>
     *
     * @param ans_M_Kei ans_M_Kei
     */
    public void setAns_M_Kei(String ans_M_Kei) {
        Ans_M_Kei = ans_M_Kei;
    }
     ...
     * </pre>
     *
     * @param ans_M_Sokin ans_M_Sokin
     */
    public void setAns_M_Sokin(String ans_M_Sokin) {
        Ans_M_Sokin = ans_M_Sokin;
    }

    /**
     * <pre>
     * ans_M_TatekaeZanAfterUkeireを取得します。
     * </pre>
     *
     * @return ans_M_TatekaeZanAfterUkeire
     */
    public String getAns_M_TatekaeZanAfterUkeire() {
        return Ans_M_TatekaeZanAfterUkeire;
    }

    /**
     * <pre>
     * ans_M_TatekaeZanAfterUkeireを設定します。
     * </pre>
     *
     * @param ans_M_TatekaeZanAfterUkeire ans_M_TatekaeZanAfterUkeire
     */
    public void setAns_M_TatekaeZanAfterUkeire(String ans_M_TatekaeZanAfterUkeire) {
        Ans_M_TatekaeZanAfterUkeire = ans_M_TatekaeZanAfterUkeire;
    }
