...
// Class Name   : Md001_02BackController
//
...
/**
 * <pre>
 * このクラスはMd001_02の戻るボタンコントローラークラスです。
 * </pre>
 *
 * @author 田旗　秀樹
 * @version 1.0.0
...
@RequestMapping(value = "/Md001_02Back.form")
public class Md001_02BackController extends Md001_02BaseController {
    ...
    public String executeAction(Model model, Md001_02Form form, Errors errors, HttpServletRequest request,
        ...
        // 遷移画面を変更する。
        if (Md001Constants.PROCESS_MODE_5.equals(form.getProcessMode())) {
            ...
            // 　　貸付実行報告書取消・修正（入力画面）を呼出す。
            // 　　　md001_01:貸付実行報告書取消・修正（入力画面）
            return success(Md001Constants.EVENT_ID_MD001_01RETURN);
        }
    }
