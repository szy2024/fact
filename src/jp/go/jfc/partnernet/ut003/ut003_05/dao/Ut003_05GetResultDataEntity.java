...
// Class Name   : Ut003_05GetResultDataEntity
//
...
/**
 * <pre>
 * このクラスはUt003_05GetResultDataDAOのEntityクラスです。
 * </pre>
 *
 * @author 譚　暁玉
 * @version 1.0.0
 */
public class Ut003_05GetResultDataEntity extends PNBaseEntity {
     ...
     * @return 文書様式番号
     */
    public String getID_FormatNumber() {
        return (String) getValue("ID_FormatNumber");
    }

    /**
     * 文書様式番号を設定します。
     * @param ID_FormatNumber 文書様式番号
     */
    public void setID_FormatNumber(String ID_FormatNumber) {
        setValue("ID_FormatNumber", ID_FormatNumber);
    }
