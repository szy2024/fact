...
// Class Name   : Cr005_02InitController
//
...
/**
 * <pre>
 * このクラスはcr005_02の初期表示コントローラークラスです。
 * </pre>
 *
 * @author 小菱　忠雄
 * @version 1.0.0
...
@RequestMapping(value = "/Cr005_02Init.form")
public class Cr005_02InitController extends Cr005_02BaseController {
    ...
    public String executeAction(Model model, Cr005_02Form form, Errors errors, HttpServletRequest request,
        ...
        form.setLblSearchCustomer((String) paramMap.get(Cr005Constants.PROPERTY_02_IN_NAME_CUSTOMER));
        ...
        if (null != loginInfo) {
            form.setCr005_02_Code_Organizaion(loginInfo.getCode_Organization());
        }
        ...
        // CFWBeanUtils.copyProperties(inCr005_02DTO, form);
        // ============ ↓↓↓↓個別実装部分↓↓↓↓ ============
        // DTOへの転記処理をここに実装
        ...
        if (0 == outCr005_02DTO.getMEISAI_LIST1().size()) {
            ...
            cr005_02m1Table.setResultsPerPage(form.getID_AllCount());
